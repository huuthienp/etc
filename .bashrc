...
# Check to see if currently in an SSH session or not
...
export JAVA_HOME=$HOME/scoop/apps/oraclejre8/current
export PDSH_RCMD=ssh
...
export SPARK_HOME=$HOME/scoop/apps/spark-hadoop3/current
